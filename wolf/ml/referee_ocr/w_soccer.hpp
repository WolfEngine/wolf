...
typedef void ocr_callback(char *p_result_buffer,
                          int p_result_buffer_size,
...
class w_soccer : public w_referee {
  ...
  */
  ...
  The function return the config of desired image window.
          ...
          \param p_type The type of box
          \return
  */
  W_API static w_ocr_engine::config_struct set_config(_In_ char *p_type);
  ...
  */
  ...
  W_API config_for_ocr_struct set_config_for_ocr(_In_ char *p_type);

  /*!
          The function returns frame results, the results are extracted from
     pre-defined frame boxes.

          \param p_frame The input frame image.
          \param p_frame_data The frame result would be stored in the frame_date.
          \return Void
  */
  ...
  */
  ...
  /*!
     ...
     penalty results the results would be extracted.
          ...
          \param p_frame The input frame image.
          \param p_digits_candidates The cluster of digits characters.
          \param p_words_candidates The cluster of words characters.
          \param p_time_candidates The cluster of time stat related characters.
          \param p_frame_data The frame result would be stored in the frame_date.
          \return Void
  */
  ...
  result.
          ...
          \param p_raw_image The sequence of the input image pixels array in BGR
                format.
          \param p_height The image height.
          \param p_width The image width.
          \param p_callback The callback.
          \return Void
  */
  W_API int single_image_result_extraction(_In_ uint8_t *p_raw_image,
                                            _In_ int p_height,
                                            _In_ int p_width,
  ...
  related to the frame result.
          ...
          \param p_digits_candidates The character clusters of the result texts.
          \param p_words_candidates The character clusters of the team name texts.
          \param p_time_candidates The character cluster of the stat texts.
          \return Void
  */
  ...
  */
  ...
  initial values.
          ...
          \param p_frame_data input struct
          \param p_image input struct
  ...
  */
  ...
  The update_match_data function store frames data in the match_date variable.
          ...
          \return
  */
  W_API void update_match_data(_In_ w_referee::frame_result_struct p_frame_data,
                               _In_ cv::Mat &p_image);
